...
class DadosPaciente(models.Model):
    ...
    def __str__(self):
        ...
        # Criar o arquivo para ser enviado para o  banco de dados 
        # python3 manage.py makemigrations

        # Enviar o arquivo para o baco de dados 
        # python3 manage.py migrate

        # consultar nas pastas migrattions

###################################################  
 
# ARMAZENAR A REFEIÇÃO DO PACIENTE EM BANCO DE DADOS       
...
# # ARMAZENAR A OPÇÃO DE REFEIÇÃO DO PACIENTE EM BANCO DE DADOS       
